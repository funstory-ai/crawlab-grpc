...
type NodeServiceClient interface {
	...
	Unregister(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
...
func (c *nodeServiceClient) Unregister(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/grpc.NodeService/Unregister", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServiceServer interface {
	...
	Unregister(context.Context, *Request) (*Response, error)
...
func (UnimplementedNodeServiceServer) Unregister(context.Context, *Request) (*Response, error) {
...
func _NodeService_Unregister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.NodeService/Unregister",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).Unregister(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
